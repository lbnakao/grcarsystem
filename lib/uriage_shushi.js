...
const METRIC_MAP = {
  ...
  '飲食売上': '飲食売上', '昨年売上': '昨年売上', '経費予測': '経費予測', '経費実績': '経費実績',
  '販売客室数': '販売客室数', '利用人数': '利用人数', '稼働率': '稼働率', '客室単価': '客室単価', '客単価': '客単価',
};
// 編集グリッドで使う指標の表示順
const METRIC_ORDER = ['目標売上', '売上実績', '客室売上', '飲食売上', 'レジ売上', '昨年売上', '経費予測', '経費実績', '販売客室数', '利用人数', '稼働率', '客室単価', '客単価'];
...
module.exports = { renderSheets, parseEntries, parseMetrics, METRIC_ORDER, DEFAULT_FILE };
